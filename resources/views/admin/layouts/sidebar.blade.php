    ...
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
           <figure class="mb-0 mx-auto">
                                           <img src="{{ asset($settings['site_logo']) }}" class="img-fluid logo" aria-label="Go to Mazhub" alt="Mazhub Logo" style="width: 150px;">

                </figure>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
           <figure class="mb-0 mx-auto">
                    <a href="https://mazhub.com">
                        <img src="https://mazhub.com/uploads/Ellbp6i3YchMMpu1mxPl4r71qHLNiD.webp" class="img-fluid logo" aria-label="Go to Mazhub" alt="Mazhub Logo" style="width: 120px;">
                    </a>
                </figure>
        </div>
